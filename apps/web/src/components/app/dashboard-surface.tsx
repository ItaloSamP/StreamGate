    ...
    <div className={`dash-frame ${locked ? 'dash-frame--locked' : ''}`}>
        ...
        <div className="dash-main">
          <header className="dash-topbar">
            <div className="dash-topbar-left">
              <div className="dash-topbar-eyebrow">Visao geral do sistema</div>
              <div className="dash-topbar-title">Dashboard Operacional</div>
            </div>
            ...
            <button type="button" className="dash-btn">Exportar</button>
            <button type="button" className="dash-btn dash-btn--primary">+ Upload</button>
          </header>

          <div className="dash-alert-strip">
            <span className="dash-alert-icon">⚠</span>
            <span><strong>2 jobs falharam</strong> nas ultimas 2h — #JB-0436, #JB-0431. Reprocessamento disponivel.</span>
            <span className="dash-alert-link">Revisar →</span>
            <span className="dash-alert-close">✕</span>
          </div>
      ...
      {locked ? (
        <div className="dash-locked-overlay">
          <div className="dash-locked-chip">Preview da dashboard liberado apos login</div>
        </div>
      ) : null}
    </div>
  )
