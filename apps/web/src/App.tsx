...
const AuditPage = lazy(() => import('@/features/operations/pages/AuditPage').then(module => ({ default: module.AuditPage })))
const DashboardPage = lazy(() => import('@/features/dashboard/pages/DashboardPage').then(module => ({ default: module.DashboardPage })))
const EventLogPage = lazy(() => import('@/features/operations/pages/EventLogPage').then(module => ({ default: module.EventLogPage })))
const ClickHousePage = lazy(() => import('@/features/analytics/pages/ExplorationPages').then(module => ({ default: module.ClickHousePage })))
const EtlExplorerPage = lazy(() => import('@/features/analytics/pages/ExplorationPages').then(module => ({ default: module.EtlExplorerPage })))
const JobsPage = lazy(() => import('@/features/uploads/pages/JobsPage').then(module => ({ default: module.JobsPage })))
const LandingPage = lazy(() => import('@/features/public/pages/LandingPage').then(module => ({ default: module.LandingPage })))
const AuditDetailPage = lazy(() => import('@/features/operations/pages/OperationalDetailPages').then(module => ({ default: module.AuditDetailPage })))
const DlqDetailPage = lazy(() => import('@/features/operations/pages/OperationalDetailPages').then(module => ({ default: module.DlqDetailPage })))
const JobDetailPage = lazy(() => import('@/features/operations/pages/OperationalDetailPages').then(module => ({ default: module.JobDetailPage })))
const QuarantineDetailPage = lazy(() => import('@/features/operations/pages/OperationalDetailPages').then(module => ({ default: module.QuarantineDetailPage })))
const LoginPage = lazy(() => import('@/features/auth/pages/LoginPage').then(module => ({ default: module.LoginPage })))
const NotificationsPage = lazy(() => import('@/features/operations/pages/NotificationsPage').then(module => ({ default: module.NotificationsPage })))
const OperationsPage = lazy(() => import('@/features/operations/pages/OperationsPage').then(module => ({ default: module.OperationsPage })))
const QuarantinePage = lazy(() => import('@/features/operations/pages/QuarantinePage').then(module => ({ default: module.QuarantinePage })))
...
const UploadPage = lazy(() => import('@/features/uploads/pages/UploadPage').then(module => ({ default: module.UploadPage })))
