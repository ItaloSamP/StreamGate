...
- Objetivo original da sprint:
- Resultado real da sprint:
...
- Item:
  ...
  - Vai para qual sprint ou trilha?:
...
- A ordem das proximas sprints continua fazendo sentido?: `sim` ou `nao`
