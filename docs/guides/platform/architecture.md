...
As convencoes detalhadas de backend, envelopes de erro, nomenclatura oficial e rastreabilidade foram consolidadas em [Fundacoes do backend](C:/estudos/StreamGate/docs/guides/backend/backend-foundations.md).
